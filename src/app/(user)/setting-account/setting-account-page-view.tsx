          ...
          <div className="flex w-full gap-x-4 py-4 px-1">
            <div className="relative">
              ...
              <div
                ...
                className="absolute bottom-0 left-[80%] border w-[30px] flex gap-3 bg-slate-300 rounded-md p-1 cursor-pointer"
              >
                <Image
                  src={"/camera_icon.svg"}
                  alt="icon"
