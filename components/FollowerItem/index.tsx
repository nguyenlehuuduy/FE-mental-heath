      ...
      <div className="flex flex-row items-center gap-2 shrink-0">
        {item.followStatus ? (
          ...
          <button
            ...
            className="w-full bg-white px-4 py-2 rounded-md border border-[#0F52BA] text-[#0F52BA] font-bold text-xs hover:bg-slate-50"
          >
            Theo dõi lại
          </button>
        )}

        <button className="bg-white px-4 py-2 rounded-md border border-[#3D3D3D] text-[#3D3D3D] font-bold text-xs ">
          Xóa
        </button>
      </div>
    </div>
