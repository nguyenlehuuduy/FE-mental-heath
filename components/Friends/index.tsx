    ...
    <div className="flex flex-col justify-center px-8 bg-white">
      <div className="flex flex-row items-center gap-4 border-b justify-between">
        <div
          ...
          className={`${showComponent === 0 ? "text-[#0F52BA] font-bold border-b-2 border-[#0F52BA]" : "text-[#3D3D3D]"} cursor-pointer flex flex-col justify-center py-3`}
        >
          <span className="text-lg">Đang theo dõi</span>
        </div>
        <div
          onClick={() => setShowComponent(1)}
          className={`${showComponent === 1 ? "text-[#0F52BA] font-bold border-b-2 border-[#0F52BA]" : "text-[#3D3D3D]"} cursor-pointer flex flex-col justify-center py-3`}
        >
          <span className="text-lg">Người theo dõi</span>
        </div>
        <div
          onClick={() => setShowComponent(2)}
          className={`${showComponent === 2 ? "text-[#0F52BA] font-bold border-b-2 border-[#0F52BA]" : "text-[#3D3D3D]"} cursor-pointer flex flex-col justify-center py-3`}
        >
          <span className="text-lg">Xác nhận theo dõi</span>
        </div>
        <div
          onClick={() => setShowComponent(3)}
          className={`${showComponent === 3 ? "text-[#0F52BA] font-bold border-b-2 border-[#0F52BA]" : "text-[#3D3D3D]"} cursor-pointer flex flex-col justify-center py-3`}
        >
          <span className="text-lg">Đề xuất cho bạn</span>
        </div>
      </div>
