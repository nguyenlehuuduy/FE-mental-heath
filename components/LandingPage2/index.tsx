...
export default function LandingPage2() {
  return (
    <div className="flex flex-col py-10 items-center">
      ...
      <div className="flex items-center justify-evenly gap-5 py-10 max-w-[1280px]">
        <div className="cursor-pointer">
          <div className="w-[280px] h-[450px] bg-[#D7EFFF] rounded-xl">
        ...
        <div className="cursor-pointer">
          <div className="flex flex-col w-[280px] h-[450px] bg-[#0F52BA]  rounded-xl">
            <div className="flex items-center justify-center py-5">
              <Image
                className="object-contain"
                width={200}
        ...
        <div className="cursor-pointer">
          <div className="w-[280px] h-[450px] bg-[#0F52BA] rounded-xl">
            <div className="flex items-center justify-center py-5">
              <Image
                className="object-contain"
                width={200}
